...
| [`vip-discovery-stepup.mmd`](vip-discovery-stepup.mmd) | sequence | The gateway-derived VIP discovery probe and the policy-enforced step-up it forces - the agent cannot skip it. | [concepts/human-in-the-loop](../concepts/human-in-the-loop.md) |
